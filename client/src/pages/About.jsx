      ...
      <div className="flex h-full  w-full flex-col items-center justify-center">
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            Welcome to NITA-EXAMBUDDY, the ultimate hub for National Institute of Technology Agartala ,students to seamlessly
        ...
        <div className="">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
            It is more than just a website; it's a community-driven
            ...
            education should be a collective journey.
          </p>
        </div>
        <div className="">
          <h1 className="relative w-fit text-2xl font-bold before:absolute before:top-[90%] before:h-[3px] before:w-[60%] before:bg-[#2563eb] lg:text-4xl lg:before:top-full">
          ...
          <p className="mt-1 text-[15px] lg:mt-3">
             our mission is clear: to empower students by
